...
with open(os.path.join(out_dir, "rt_1blk.bin"), "wb") as f:
    f.write(flat.tobytes())
with open(os.path.join(out_dir, "rt_1blk.json"), "w") as f:
    json.dump(manifest, f)
print(f"{len(keys)} tensors, {flat.size * 4 // 1024 // 1024} MB -> assets/rt_1blk.bin/.json")
